...
(function ($) {
    ...
    // let couterDisplay = $('body').find(".ec-product-inner");

    // for (let index = 0; index < couterDisplay.length; index++) {
    //     let element = $(couterDisplay[index]);

    //     let productId = element.find('.product_id').val(),
    //         promoStart = element.find('.promo_start').val(),
    //         promoEnd = element.find('.promo_end').val();

        // if (new Date() >= new Date(promoStart) && new Date() <= new Date(promoEnd)) {
        //     element.find(".ec-fs-count-" + productId)
        //         .countdown(new Date(element.find(".ec-fs-count-" + productId).data('endpromo')), function (event) {
        //             $('.ec-fs-count-' + productId).text(
        //                 event.strftime('%D jour %H:%M:%S')
        //             );
        //         });
        // }
    // }
    ...
    // console.log($('.ec-fs-count').data('startpromo')+' // '+$('.ec-fs-count').data('endpromo'))
    ...
    $('.ec-category-section .ec_cat_slider_2').slick({
        rows: 1,
        dots: false,
        arrows: true,
        infinite: true,
    ...
    $('.ec-category-toggle').click(function(){
        $('.mobile-menu').toggleClass('ec-open');
    })
